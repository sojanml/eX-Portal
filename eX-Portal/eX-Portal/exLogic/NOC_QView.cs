...
namespace eX_Portal.exLogic
{
    public class NOC_QView
    {
       ...
       public static  StringBuilder Data = new StringBuilder();
        ...
        private List<NOC_qViewMenu> qViewMenus = new List<NOC_qViewMenu>();
        private bool IsPrimaryKey = false;
        public bool IsFormatDate = true;

        public NOC_QView(String sSQL = "", bool isFilterByTop = true)
        {
            if (sSQL != "") SQL = sSQL;
            _TotalRecords = 0;
        ...
        {
            NOC_qViewMenu Menu = new NOC_qViewMenu
            {
                Caption = Caption,
                URL = URL,
                Icon = Icon
        ...
        public String getScripts()
        {
            ...
            foreach (var Column in ColumDef)
            {
                ...
                {
                    ScriptColumns.Append(", \"render\" : function(data, type, row) {");
                    //ScriptColumns.Append("return '<span style=\"color:red\">'+data+'</span>'}");
                    ScriptColumns.Append("\n var values = data.split(\"\\n\");");
                    ScriptColumns.Append("\n var Approved = values[0].split(\" \");");

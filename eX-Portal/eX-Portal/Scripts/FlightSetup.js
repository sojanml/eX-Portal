...
function DroneID_Success(Row) {
  ...
  if (Row.hasRows) {
    FORM['DroneSetup.PilotUserId'].value = Row.PilotUserId;
    FORM['DroneSetup.GroundStaffUserId'].value = Row.GroundStaffUserId;
    FORM['DroneSetup.NotificationEmails'].value = Row.NotificationEmails;
    ...
    DroneApprovals = [];
    FORM['DroneSetup.PilotUserId'].value = '';
    FORM['DroneSetup.GroundStaffUserId'].value = '';
    FORM['DroneSetup.NotificationEmails'].value = '';
    FORM['GcaApproval.ApprovalName'].value = '';
  }

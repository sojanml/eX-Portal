...
$(document).ready(function () {
    ...
    $('#itm_DroneID').on("change", function () {
        if ($(this).val() != '0') {
            $('#uploadGroup').slideDown();
            selectedDroneID = $(this).val();
            UploadURL = '/Payload/UploadFile?ID=' + selectedDroneID + "&DocumentType=Geo Tag";
            DeleteURL = '/Payload/DeleteFile?ID=' + selectedDroneID + "&DocumentType=Geo Tag";
    ...
    $('#itm_DocsType').on("change", function () {
        if ($(this).val() != '') {
            $('#uploadGroup').slideDown();
            selectedDroneID = $(this).val();
        } else {
